...
--local compiled = token("compiled", lexer.range(""

--lex:add_rule("compiled", token(lexer.INDENTIFIER,
--
--lex:add_style("compiled", lexer.STYLE_NUMBER)

	--[[
lex:add_rule("identifier", token(lexer.NUMBER,
  (lexer.alnum + S('+-*=<>.?/\'%,_$#'))^1))
]]
--[[
lex:add_rule("incomplete_definition", token(lexer.ERROR,
	lexer.range(":", ":")))
